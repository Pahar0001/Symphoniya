...
const REVIEWS = [
  { author: "Анна К.", city: "Москва", rating: 5, text: "Заказывали кухню из дуба — сделали точно в срок, качество превзошло ожидания. Отдельное спасибо дизайнеру — помог определиться со стилем.", source: "site" },
