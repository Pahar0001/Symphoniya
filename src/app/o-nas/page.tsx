...
export default function AboutPage() {
  return (
    <>
      <CategoryHero
        eyebrow="О компании"
        title="Мастерская «Симфония мебели»"
        description="Свой цех, честные материалы и внимание к мелочам, из которых складывается хорошая мебель."
      />
      ...
      <section id="istoriya" className="section pt-2">
        <Container className="max-w-3xl space-y-6 text-lg leading-relaxed text-muted">
          <Reveal>
            <p>
              «Симфония мебели» — мастерская в Москве, где мы делаем кухни, шкафы, гардеробные
              и сан-узлы на заказ. Работаем руками, беремся за сложные проекты и собрали команду,
              которой не страшно доверить нестандартную задачу.
            </p>
          </Reveal>
          <Reveal delay={80}>
            <p>
              Мы точно знаем, где мы сильны — кухни, шкафы, гардеробные и сан-узлы. Выбрали спокойную,
              взрослую эстетику вместо погони за трендами и подтянули производство под неё. Мебель,
              которая не кричит, а служит годами и остаётся уместной.
            </p>
          </Reveal>
        </Container>
      </section>
