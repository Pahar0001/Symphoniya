  ...
  return (
    <section className="section">
      <Container className="max-w-3xl space-y-5 text-graphite-600">
        <h1 className="font-heading text-4xl text-graphite-800">Политика конфиденциальности</h1>
        <p className="text-sm text-graphite-400">
          Настоящая политика составлена в соответствии с Федеральным законом № 152-ФЗ
          «О персональных данных».
        </p>
        <h2 className="pt-4 font-heading text-2xl text-graphite-800">1. Общие положения</h2>
        <p>
        ...
        <h2 className="pt-4 font-heading text-2xl text-graphite-800">2. Цели обработки</h2>
        <p>
          Обработка заявок, консультирование, оформление и исполнение заказов, обратная связь.
        </p>
        <h2 className="pt-4 font-heading text-2xl text-graphite-800">3. Условия обработки</h2>
        <p>
