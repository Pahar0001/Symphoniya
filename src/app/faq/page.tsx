...
const FAQ: { group: string; items: { q: string; a: string }[] }[] = [
  ...
  },
  {
    group: "Цена и оплата",
    items: [
      { q: "Из чего складывается цена?", a: "Из фасадов, корпусов, столешницы, фурнитуры, техники и монтажа. Смету показываем по пунктам — без скрытых доплат." },
  ...
  return (
    <>
      <CategoryHero
        eyebrow="Помощь"
        title="Вопросы и ответы"
        description="Собрали то, о чём чаще всего спрашивают. Не нашли ответ — позвоните или напишите нам."
      />
